...
class PhaseDRXTool(QMainWindow):
    ...
    def new_project(self):
        QMessageBox.information(self, "Novo Projeto",
                                "Para criar um novo projeto, por favor, feche esta janela e use a opção 'Ferramentas > PhaseDRX' novamente.")
    ...
    def load_experimental_files(self):
        file_filter = "Arquivos de Dados (*.xy *.dat *.asc *.int);;Todos os Arquivos (*)"
